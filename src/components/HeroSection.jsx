...
export function HeroSection() {
    return (
      <main className="container px-4 lg:px-4  mx-auto mb-12 md:mb-20 mt-12 lg:mt-0">
        ...
        <span className="text-cyan-600 inline lg:inline">Stay</span>
        <span className="text-cyan-600 inline lg:block"> Informed,</span>
        <span className="text-cyan-600 block lg:inline">Stay Inspired</span>
        </h1>
        ...
        <h2 className="text-cyan-600 text-xl font-semibold mb-2 mt-4 lg:mt-0">-Author</h2>
        <h3 className="text-cyan-600 text-2xl font-bold mb-4">Sofia Blake</h3>
