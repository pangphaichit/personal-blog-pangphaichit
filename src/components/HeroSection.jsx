export function HeroSection() {
    return (
      <main className="container px-4 lg:px-4 py-8 lg:py-16 mx-auto">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-center mb-4 pl-4 lg:pl-20 lg:text-right">
  ...
  <span className="block lg:inline">Stay Inspired,</span>
        ...
        <img src="/womanwithcat.jpg" alt="A woman with a cat on her back."  className="h-[530px] object-cover rounded-lg shadow-lg lg:w-1/3 mx-4 mb-8 lg:mb-0"/>
        <div className="lg:w-1/3 lg:pl-8">
        <h2 className="text-xl font-semibold mb-2">-Author</h2>
        <h3 className="text-2xl font-bold mb-4">Sofia Blake.</h3>
        <p className="text-gray-500 mb-4 pr-20">
